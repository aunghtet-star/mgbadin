  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-10 gap-4 bg-slate-50 dark:bg-slate-950/20 p-4 rounded-3xl border border-slate-100 dark:border-slate-900/50 shadow-sm">
